    ...
    <transition mode="out-in" :name="transition">
      <div :key="currentIndex" class="item">
        ...
        <img
          class="avatar"
          :src="
            require(`~/assets/images/index/testimonials/${current.image}?resize&sizes[]=200`)
          "
          :alt="current.name"
        />
      </div>
...
const ITEMS = [
  {
    ...
    image: "stuart_l.jpg",
    content:
      "My favorite thing about Pop_OS! Is that it literally gets out of your way and I can get so much work done without any problems. My favorite feature has to be the docker and the sweet animations!!!",
  },
  {
    name: "Robert H.",
    image: "robert_h.jpg",
