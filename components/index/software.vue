<template>
  <section :class="classes">
    <gradient-br class="top" />

    <sys-header-2>Compatible with most software tools</sys-header-2>

    <sys-paragraph-1>
      That app you desperately need in order to function? We probably have it.
      The vast software libraries of Ubuntu and Flatpak combine to make all of
      your tools available in a single location, called the Pop!_Shop. The
      Pop!_Shop is our version of Android’s Play Store or the App Store on iOS,
      and we’re constantly adding new applications to the mix—a productivity
      cocktail that goes down smooth.
    </sys-paragraph-1>

    <div v-lazy-container="{ selector: 'img' }" class="grid">
      ...
      <a href="https://www.chromium.org/" target="_blank" rel="noopener">
        <img
          ...
          :data-loading="
            require('~/assets/images/index/apps/chromium.png?lqip')
          "
        />
      </a>
      ...
      <a href="https://atom.io/" target="_blank" rel="noopener">
        <img
          alt="Atom"
          title="Atom"
      ...
      <a href="https://www.videolan.org/vlc/" target="_blank" rel="noopener">
        <img
          alt="VLC"
          title="VLC"
      ...
      <a href="https://www.plex.tv/" target="_blank" rel="noopener">
        <img
          alt="Plex"
          title="Plex"
      ...
      <a href="https://inkscape.org/" target="_blank" rel="noopener">
        <img
          alt="Inkscape"
          title="Inkscape"
          :data-src="require('~/assets/images/index/apps/inkscape.png?size=60')"
          :data-loading="
            require('~/assets/images/index/apps/inkscape.png?lqip')
          "
        />
      </a>

      <a href="https://www.gimp.org/" target="_blank" rel="noopener">
        <img
          alt="GIMP"
          title="GIMP"
      ...
      <a href="https://telegram.org/" target="_blank" rel="noopener">
        <img
          ...
          :data-loading="
            require('~/assets/images/index/apps/telegram.png?lqip')
          "
        />
      </a>
    </div>

    <gradient-br class="bottom" />
  </section>
</template>
...
.grid a:focus,
.grid a:active {
  box-shadow: inset 0 0 0 1px var(--color-orange), 0 0 12px var(--color-orange),
...
<script>
import GradientBr from "~/components/gradient-br";
